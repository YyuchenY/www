...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['console.command.cache.purge'] = new \phpbb\console\command\cache\purge($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('auth'), $this->get('log'), $this->get('user'), $this->get('config'));
    }
    ...
    {
        return $this->services['console.command.extension.disable'] = new \phpbb\console\command\extension\disable($this->get('ext.manager'), $this->get('log'));
    }
    ...
    {
        return $this->services['console.command.extension.enable'] = new \phpbb\console\command\extension\enable($this->get('ext.manager'), $this->get('log'));
    }
    ...
    {
        return $this->services['console.command.extension.purge'] = new \phpbb\console\command\extension\purge($this->get('ext.manager'), $this->get('log'));
    }
    ...
    {
        return $this->services['console.command.extension.show'] = new \phpbb\console\command\extension\show($this->get('ext.manager'), $this->get('log'));
    }
    ...
    {
        return $this->services['controller.helper'] = new \phpbb\controller\helper($this->get('template'), $this->get('user'), $this->get('config'), $this->get('controller.provider'), $this->get('ext.manager'), './', 'php');
    }
    ...
    protected function getDbal_ConnService()
    {
        ...
        $instance->sql_connect('localhost', 'root', 'juju831', 'phpBB3', '', false, false);
