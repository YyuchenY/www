...
<body style="overflow-x: hidden;margin:0 0 0 0 ;background-color:#333333;">
		...
		<div class='frame' id='frame'>
			...
			<section id="options">
				<p id="navigation">
				  <button  id="previous" data-increment="-1"><img src='../img/arrow.png' style='height:30px;width:30px;transform:rotate(180deg);'  data-increment="-1"></button>
				  <button  id="next" data-increment="1"><img src='../img/arrow.png' style='height:30px;width:30px;' data-increment="1"></button>
				</p>
			</section>
